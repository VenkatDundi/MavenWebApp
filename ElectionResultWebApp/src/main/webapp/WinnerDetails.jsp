...
<html lang="en"> 
    ...
    <body> 
        ...
        <div style="margin-top: 2%;">  
                <h2 class="ui yellow header" style="text-align:center;"> Winning Candidate Details </h2>
        </div>
         
        <form name="passwinnerdetails" action="getWinner" style="margin-top: 2%;margin-bottom: 2%;"> 
                    ...
                    <tr> 
                      <td> 
                        <div class="ui labeled input"> 
                          ...
                          <input type="text" name='Constituency' placeholder="Enter here!" required> 
                        </div> 
                      </td> 
                    </tr> 
